const experience = [
	...
	},
	{
		...
		description: 'As a front end developer working on the marketing website, I am responsible for all areas of development, including writing PHP for the WordPress theme, writing the SCSS for the styling, writing the JavaScript, and managing our build tooling (Webpack)',
		projects: [
			{
				name: 'EverPress',
